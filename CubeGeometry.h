...
Vertex vertices[] =
{
	{ Vector3(-1.0f, -1.0f, 1.0f), Vector3(0.0f) },    // side 1
	{ Vector3(1.0f, -1.0f, 1.0f), Vector3(0.0f) },
	{ Vector3(-1.0f, 1.0f, 1.0f), Vector3(0.0f) },
	{ Vector3(1.0f, 1.0f, 1.0f), Vector3(0.0f) },

	{ Vector3(-1.0f, -1.0f, -1.0f), Vector3(0.0f) },    // side 2
	{ Vector3(-1.0f, 1.0f, -1.0f), Vector3(0.0f) },
	{ Vector3(1.0f, -1.0f, -1.0f), Vector3(0.0f) },
	{ Vector3(1.0f, 1.0f, -1.0f), Vector3(0.0f) },

	{ Vector3(-1.0f, 1.0f, -1.0f), Vector3(0.0f) },    // side 3
	{ Vector3(-1.0f, 1.0f, 1.0f), Vector3(0.0f) },
	{ Vector3(1.0f, 1.0f, -1.0f), Vector3(0.0f) },
	{ Vector3(1.0f, 1.0f, 1.0f), Vector3(0.0f) },

	{ Vector3(-1.0f, -1.0f, -1.0f), Vector3(0.0f) },    // side 4
	{ Vector3(1.0f, -1.0f, -1.0f), Vector3(0.0f) },
	{ Vector3(-1.0f, -1.0f, 1.0f), Vector3(0.0f) },
	{ Vector3(1.0f, -1.0f, 1.0f), Vector3(0.0f) },

	{ Vector3(1.0f, -1.0f, -1.0f), Vector3(0.0f) },    // side 5
	{ Vector3(1.0f, 1.0f, -1.0f), Vector3(0.0f) },
	{ Vector3(1.0f, -1.0f, 1.0f), Vector3(0.0f) },
	{ Vector3(1.0f, 1.0f, 1.0f), Vector3(0.0f) },

	{ Vector3(-1.0f, -1.0f, -1.0f), Vector3(0.0f) },    // side 6
	{ Vector3(-1.0f, -1.0f, 1.0f), Vector3(0.0f) },
	{ Vector3(-1.0f, 1.0f, -1.0f), Vector3(0.0f) },
	{ Vector3(-1.0f, 1.0f, 1.0f), Vector3(0.0f) }
};
